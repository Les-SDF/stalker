...
{
    /**
     * A person who does not identify themselves with or experience any gender. Agender people are also called
     * null-gender, genderless, gendervoid, or neutral gender.
     */
    case Agender = 'agender';

    /**
     * Associated with being profound, deep, and infinite. The term abimegender may be used alone or in combination
     * with other genders.
     */
    case Abimegender = 'abimegender';

    /**
     * A gender that is indefinable or indomitable. People identifying with this gender refuse to be categorized in
     * any particular gender identity.
     */
    case AdamasGender = 'adamas_gender';

    /**
     * Also called evaisgender, this gender identity changes according to one’s surroundings.
     */
    case Aerogender = 'aerogender';

    /**
     * Also called aesthetgender, it is a type of gender identity derived from aesthetics.
     */
    case Aesthetigender = 'aesthetigender';

    /**
     * This is based on the person’s mood swings or fluctuations.
     */
    case Affectugender = 'affectugender';

    /**
     * A person with this gender identity is mostly agender with brief shifts of belonging to other gender types.
     */
    case Agenderflux = 'agenderflux';

    /**
     * The person has a fluid gender identity between more than one type of gender although they cannot name the
     * genders they feel fluid in.
     */
    case Alexigender = 'alexigender';

    /**
     * This gender identity stands apart from existing social gender constructs. It means having a strong specific
     * gender identity that is neither male nor female.
     */
    case Aliusgender = 'aliusgender';

    /**
     * Having a gender identity that changes depending on the person one is emotionally attached to.
     */
    case Amaregender = 'amaregender';

    /**
     * Having two specific gender identities simultaneously without any fluidity or fluctuations.
     */
    case Ambigender = 'ambigender';

    /**
     * The person identifies themselves as both man and woman and yet does not belong to either.
     */
    case Ambonec = 'ambonec';

    /**
     * A gender-fluid identity where a person changes their gender depending on the friends they have.
     */
    case Amicagender = 'amicagender';
    ...
    /**
     * The person feels close to a specific type of gender despite being more comfortable in closely identifying
     * themselves with another gender.
     */
    case Anesigender = 'anesigender';

    /**
     * The person desires to be without any primary sexual characteristics although they do not identify themselves
     * as genderless.
     */
    case Angenital = 'angenital';

    /**
     * The gender identity fades in and out in intensity but always comes back to the same gendered feeling.
     */
    case Anogender = 'anogender';

    /**
     * The person has a gender identity but does not label it or would prefer to not have a label.
     */
    case Anongender = 'anongender';

    /**
     * A protean gender that can be anything but is formless and motionless.
     */
    case Antegender = 'antegender';

    /**
     * This gender identity has anxiety as its prominent characteristic.
     */
    case Anxiegender = 'anxiegender';

    /**
     * The person has apathy or a lack of feelings toward one's gender identity.
     */
    case Apagender = 'apagender';

    /**
     * It means knowing what are not the characteristics of gender but not knowing what are its characteristics.
     * Thus, a person hides its primary characteristics from the individual.
     */
    case Apconsugender = 'apconsugender';

    /**
     * The person has a bright and celestial gender identity.
     */
    case Astergender = 'astergender';

    /**
     * Having a gender identity that feels to be related to space.
     */
    case AstralGender = 'astral_gender';

    /**
     * Having a gender identity that feels to be closely related to being autistic.
     */
    case Autigender = 'autigender';

    /**
     * Having a gender experience that is deeply connected and personal to oneself.
     */
    case Autogender = 'autogender';

    /**
     * A gender identity that is between the two extremes of agender and any other type of gender. Both the genders
     * are experienced one at a time without any overlapping. The two genders are described as on the opposite ends
     * of an axis.
     */
    case Axigender = 'axigender';
     ...
     */
    case Genderfuzz = 'genderfuzz';

    /**
     * The gender fluctuates in intensity.
     */
    case Genderflux = 'genderflux';

    /**
     * The person resists to fit in societal norms concerning genders.
     */
    case Genderpuck = 'genderpuck';

    /**
     * The individual blurs the preconceived boundaries of gender in relation to the gender binary or having just
     * one gender type.
     */
     ...
     */
    case Mirrorgender = 'mirrorgender';

    /**
     * Having or experiencing all genders.
     */
    case Omnigender = 'omnigender';
